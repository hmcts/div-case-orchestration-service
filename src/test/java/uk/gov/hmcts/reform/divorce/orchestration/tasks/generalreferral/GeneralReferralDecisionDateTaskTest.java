...
public class GeneralReferralDecisionDateTaskTest extends TestCase {
    ...
    public void executeShouldAddPopulatedField() throws TaskException {
        ...
        Map<String, Object> returnedCaseData = generalReferralDecisionDateTask
            .execute(contextWithToken(), caseData);

        assertThat(returnedCaseData.isEmpty(), is(false));
        assertSame(returnedCaseData, caseData);
        assertThat(
            returnedCaseData.get(CcdFields.GENERAL_REFERRAL_DECISION_DATE),
