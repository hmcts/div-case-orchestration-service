...
public class AosOfflineBehaviourDesertionCaseValidatorTest {

    private final AosOfflineBehaviourDesertionCaseValidator classUnderTest = new AosOfflineBehaviourDesertionCaseValidator();
