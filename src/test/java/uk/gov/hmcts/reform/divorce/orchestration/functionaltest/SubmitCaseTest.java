...
public class SubmitCaseTest {
    ...
    public void givenCaseDataAndAuth_whenCaseDataIsSubmitted_thenReturnSuccess() throws Exception {
        ...
        webClient.perform(post(API_URL)
                ...
                .andExpect(content().string(containsString(convertObjectToJsonString(responseData))));
    }
    ...
    @Test
    public void givenInvalidCaseDataAndAuth_whenCaseDataIsSubmitted_thenReturnListOfErrors() throws Exception {
        List<String> validationErrors = new ArrayList<>();
        validationErrors.add("An Error has occurred");
        validationResponse.setErrors(validationErrors);

        Map<String, Object> errors = new HashMap<>();

        errors.put(VALIDATION_ERROR, validationResponse);
        ...
        webClient.perform(post(API_URL)
                ...
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().is2xxSuccessful())
                .andExpect(content().string(containsString(validationErrors.get(0))));
    }
