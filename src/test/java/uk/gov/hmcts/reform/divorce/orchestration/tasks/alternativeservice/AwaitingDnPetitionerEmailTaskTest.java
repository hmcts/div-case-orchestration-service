...
import static uk.gov.hmcts.reform.divorce.orchestration.domain.model.email.EmailTemplateNames.CITIZEN_AWAITING_DN_SERVED_BY_PROCESS;
...
public class AwaitingDnPetitionerEmailTaskTest {

    @Mock
    private EmailService emailService;

    @InjectMocks
    private AwaitingDnPetitionerEmailTask task;
    ...
    public void shouldReturnTemplate() {
        ...
        assertEquals(CITIZEN_AWAITING_DN_SERVED_BY_PROCESS, returnedTemplate);
    }
    ...
    private void verifyCitizenEmailSent(Map<String, Object> caseData) {
        verify(emailService).sendEmail(
            ...
            CITIZEN_AWAITING_DN_SERVED_BY_PROCESS.name(),
            getExpectedTemplateVars(caseData),
            "Your wife/husband has not responded to your divorce application",
