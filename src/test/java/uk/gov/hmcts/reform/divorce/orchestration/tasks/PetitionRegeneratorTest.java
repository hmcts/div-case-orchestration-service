...
public class PetitionRegeneratorTest {
    @Mock
    private DocumentGeneratorClient documentGeneratorClient;

    @InjectMocks
    private PetitionRegenerator petitionRegenerator;
    private static final String REGENERATE_MINI_PETITION_TEMPLATE_NAME = "regeneratedivorceminipetition";
    ...
    public void callsDocumentGeneratorAndStoresGeneratedDocument() {
        ...
        final GenerateDocumentRequest generateDocumentRequest =
            GenerateDocumentRequest.builder()
                .template(REGENERATE_MINI_PETITION_TEMPLATE_NAME)
        ...
        //when
        petitionRegenerator.execute(context, payload);
