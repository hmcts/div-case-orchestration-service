...
public class AosOfflineAdulteryCoRespFormToCaseTransformerTest {

    private final AosOfflineAdulteryCoRespFormToCaseTransformer classUnderTest = new AosOfflineAdulteryCoRespFormToCaseTransformer();
    ...
    public void verifyDataIsCorrectlyTransformed() {
        ...
        assertThat(transformedCaseData, allOf(
            ...
            hasEntry("CoRespAdmitAdultery", "Yes"),
