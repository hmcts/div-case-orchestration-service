...
public class SendPetitionerClarificationRequestEmailTest {

    @Mock EmailService emailService;

    @InjectMocks
    SendPetitionerClarificationRequestEmail sendPetitionerClarificationRequestEmail;
    ...
    @Test
    public void shouldCallPetEmailServiceForClairificationEmail() throws TaskException {
        ...
        Map returnPayload = sendPetitionerClarificationRequestEmail.execute(context, testData);
