...
public class GeneralEmailWorkflowTest {
    ...
    @Test
    public void shouldGeneralEmail_ToPetitionerSolicitor()
        throws WorkflowException {
        Map<String, Object> caseData = buildCaseData(GeneralEmailTaskHelper.Party.PETITIONER_SOLICITOR);

        mockTasksExecution(caseData, generalEmailPetitionerSolicitorTask);

        Map<String, Object> returnedCaseData = executeWorkflow(CcdCallbackRequest.builder().build());

        verifyTaskWasCalled(returnedCaseData, generalEmailPetitionerSolicitorTask);
    }
