...
import static uk.gov.hmcts.reform.divorce.orchestration.domain.model.CcdEvents.AMEND_PETITION_FOR_REFUSAL_EVENT_ID;
...
public class AmendPetitionForRefusalITest extends MockedFunctionalTest {
    private static final String CASE_ID = "1234567890";
    private static final String API_URL = "/amend-petition-dn-rejection";
    private static final String USER_TOKEN = "Token";
    private static final String PREVIOUS_ID = "Test.Id";
    private static final String CMS_AMEND_PETITION_CONTEXT_PATH = "/casemaintenance/version/1/amended-petition-draft-refusal";
    private static final String CMS_UPDATE_CONTEXT_PATH = String.format(
        "/casemaintenance/version/1/updateCase/%s/%s",
        CASE_ID,
        AMEND_PETITION_FOR_REFUSAL_EVENT_ID
    );
