...
public class RetryableBulkCaseWorkflowTest {
    ...
    public void given4xException_whenExecuteWithRetries_thenLogError() throws WorkflowException {
        ...
        when(retryableBulkCaseWorkflow.run(caseDetail, TEST_CASE_ID_1, AUTH_TOKEN))
            .thenThrow(new FeignException.NotAcceptable("Error", mockRequest, "Error".getBytes(), null));
    ...
    public void given422Exception_whenExecuteWithRetries_thenLogError() throws WorkflowException {
        ...
        when(retryableBulkCaseWorkflow.run(caseDetail, TEST_CASE_ID_1, AUTH_TOKEN))
                .thenThrow(new FeignException.UnprocessableEntity("Error", mockRequest, "Error".getBytes(), null));
    ...
    public void given404Exception_whenExecuteWithRetriesForCreate_thenReturnRemovableCases() throws WorkflowException {
        ...
        when(retryableBulkCaseWorkflow.run(caseDetail, TEST_CASE_ID_1, AUTH_TOKEN))
                .thenThrow(new FeignException.NotFound("Error", mockRequest, "Error".getBytes(), null));
