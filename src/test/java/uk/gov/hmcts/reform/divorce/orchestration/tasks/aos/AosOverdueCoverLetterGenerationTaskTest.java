...
import static uk.gov.hmcts.reform.divorce.orchestration.tasks.dataextractor.AddresseeDataExtractorTest.PETITIONERS_ADDRESS;
...
public class AosOverdueCoverLetterGenerationTaskTest extends BasePayloadSpecificDocumentGenerationTaskTest {
    ...
    public void shouldGenerateDocumentAndReturnItInCaseData_WhenHelpWithFeesIsPresent() throws TaskException {
        Map<String, Object> caseData = buildCaseDataWithHelpWithFees();
    ...
    public void shouldGenerateDocumentAndReturnItInCaseData_WhenHelpWithFeesIsNotPresent() throws TaskException {
        Map<String, Object> caseData = buildCaseDataWithNoHelpWithFees();
    ...
    private Map<String, Object> buildCaseDataWithHelpWithFees() {
        Map<String, Object> caseData = buildCaseDataWithNoHelpWithFees();
    ...
    private Map<String, Object> buildCaseDataWithNoHelpWithFees() {
