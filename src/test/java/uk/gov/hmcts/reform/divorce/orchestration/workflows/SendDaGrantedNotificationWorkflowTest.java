...
public class SendDaGrantedNotificationWorkflowTest {
    ...
    public void setup() throws Exception {
        ...
        when(sendDaGrantedNotificationEmail.execute(notNull(), eq(testPayload)))
    ...
    public void genericEmailTaskShouldExecuteAndReturnPayload() throws Exception {
        ...
        Map<String, Object> returnedPayload = sendDaGrantedNotificationWorkflow.run(ccdCallbackRequestRequest);
        assertThat(returnedPayload, is(equalTo(testPayload)));

        verify(sendDaGrantedNotificationEmail).execute(context, testPayload);
    }
}
