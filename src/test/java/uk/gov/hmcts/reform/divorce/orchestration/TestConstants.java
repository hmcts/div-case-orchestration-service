...
public class TestConstants {
    ...
    public static final String TEST_DECREE_ABSOLUTE_GRANTED_DATE = "2020-10-20";
    public static final String TEST_NOTIFICATION_LIMIT_DATE_TO_DOWNLOAD_CERTIFICATE = "2021-10-20";
    public static final String TEST_CUSTOMER_FACING_NOTIFICATION_LIMIT_DATE_TO_DOWNLOAD_CERTIFICATE = "20 October 2021";
    ...
    public static String TEST_DA_GRANTED_NOTIFICATION_EMAIL_DESC = "Decree Absolute Notification - Decree Absolute Granted";
