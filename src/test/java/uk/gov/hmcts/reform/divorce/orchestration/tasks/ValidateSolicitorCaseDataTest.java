...
public class ValidateSolicitorCaseDataTest {
    ...
    @Test
    public void givenValidData_whenValidateSolicitorCaseData_thenReturnCaseDataWithNoErrors() throws Exception {
    ...
    @Test
    public void givenInvalidStatementOfTruth_whenValidateSolicitorCaseData_thenReturnCaseDataWithErrors() throws Exception {
    ...
    @Test
    public void givenInvalidSolicitorStatementOfTruth_whenValidateSolicitorCaseData_thenReturnCaseDataWithErrors() throws Exception {
        caseData.put(STATEMENT_OF_TRUTH, "YES");
    ...
    @Test
    public void givenInvalidStatementsOfTruth_whenValidateSolicitorCaseData_thenReturnCaseDataWithErrors() throws Exception {
        caseData.put(STATEMENT_OF_TRUTH, "NO");
        caseData.put(SOLICITOR_STATEMENT_OF_TRUTH, "NO");
