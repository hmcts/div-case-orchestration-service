...
public class IssueAosPackOfflineWorkflowTest {
    ...
    private static final String AOS_INVITATION_LETTER = "FL-DIV-LET-ENG-00070.docx";
    ...
    public void testTasksAreCalledWithTheCorrectParams() throws WorkflowException {
        ...
        when(documentGenerationTask.execute(any(), any())).thenReturn(singletonMap("returnedKey", "returnedValue"));
