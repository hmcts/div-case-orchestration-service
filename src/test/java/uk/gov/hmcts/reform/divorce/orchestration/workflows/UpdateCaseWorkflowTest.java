...
public class UpdateCaseWorkflowTest {

    @Mock
    UpdateCaseInCCD updateCaseInCCD;

    @InjectMocks
    UpdateCaseWorkflow updateCaseWorkflow;
    ...
    public void runShouldExecuteTasksAndReturnPayload() throws Exception {
        ...
        assertEquals(testData, updateCaseWorkflow.run(testData, AUTH_TOKEN, TEST_CASE_ID, TEST_EVENT_ID));
