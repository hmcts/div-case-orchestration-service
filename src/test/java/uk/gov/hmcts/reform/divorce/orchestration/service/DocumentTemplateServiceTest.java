...
public class DocumentTemplateServiceTest {
    ...
    public void verifyEnglishTemplates() {
        ...
        verifyTemplateIdMatchesExpected(englishPreferenceCaseData, AOS_OFFLINE_UNREASONABLE_BEHAVIOUR_AND_DESERTION_TEMPLATE_ID,
            "FL-DIV-APP-ENG-00082.docx");
    ...
    public void verifyWelshTemplates() {
        ...
        verifyTemplateIdMatchesExpected(welshPreferenceCaseData, AOS_OFFLINE_UNREASONABLE_BEHAVIOUR_AND_DESERTION_TEMPLATE_ID,
            "FL-DIV-APP-WEL-00248.docx");
