...
public class GenericUpdateEmailNotificationTest {

    @Mock
    private EmailService emailService;

    @InjectMocks
    private GenericUpdateEmailNotification genericUpdateEmailNotification;
    ...
    public void whenExecuteEmailNotificationTask_thenSendDNEmail() throws NotificationClientException {
        ...
        genericUpdateEmailNotification.execute(context, payload);

        verify(emailService).sendEmail(EmailTemplateNames.GENERIC_UPDATE, TEST_USER_EMAIL, notificationTemplateVars);
    ...
    public void givenNotificationError_whenExecuteEmailNotificationTask_thenReturnEmailError() throws NotificationClientException {
        ...
        Map<String, Object> taskResponse = genericUpdateEmailNotification.execute(context, payload);
    ...
    public void givenNullInput_whenExecuteEmailNotificationTask_thenSendWithNullParameters() throws NotificationClientException {
        ...
        verify(emailService).sendEmail(EmailTemplateNames.GENERIC_UPDATE, null, notificationTemplateVars);
