...
import static uk.gov.hmcts.reform.divorce.orchestration.TestConstants.TEST_DA_GRANTED_NOTIFICATION_EMAIL_DESC;
    ...
    public void shouldCallEmailServiceForDaNotificationIfEmailsOnlyOnceIfOnlyOneEmailIsPresent() throws TaskException {
        ...
        verify(emailService,times(1))
            .sendEmail(
                ...
                eq(TEST_DA_GRANTED_NOTIFICATION_EMAIL_DESC));
