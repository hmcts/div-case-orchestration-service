...
import static uk.gov.hmcts.reform.divorce.orchestration.domain.model.email.EmailTemplateNames.PET_SOL_AWAITING_DN_SERVED_BY_PROCESS;
...
public class AwaitingDnPetitionerSolicitorEmailTaskTest {

    @Mock
    private EmailService emailService;

    @InjectMocks
    private AwaitingDnPetitionerSolicitorEmailTask task;
    ...
    public void shouldReturnTemplate() {
        ...
        assertEquals(PET_SOL_AWAITING_DN_SERVED_BY_PROCESS, returnedTemplate);
    }
    ...
    private void verifySolicitorEmailSent(Map<String, Object> caseData) {
        verify(emailService).sendEmail(
            ...
            "Solicitor apply for DN - process server",
