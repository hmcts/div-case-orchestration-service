...
public class AosOfflineBehaviourDesertionFormToCaseTransformerTest {

    private final AosOfflineBehaviourDesertionFormToCaseTransformer classUnderTest = new AosOfflineBehaviourDesertionFormToCaseTransformer();
    ...
    public void verifyDataIsCorrectlyTransformed() {
        ...
        assertThat(transformedCaseData, allOf(
            ...
            hasEntry("RespWillDefendDivorce", "Proceed"),
