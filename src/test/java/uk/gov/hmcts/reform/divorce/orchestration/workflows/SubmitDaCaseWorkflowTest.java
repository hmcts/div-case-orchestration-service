...
import static uk.gov.hmcts.reform.divorce.orchestration.domain.model.CcdEvents.DECREE_ABSOLUTE_REQUESTED_EVENT_ID;
...
public class SubmitDaCaseWorkflowTest {
    ...
    @Mock
    private FormatDivorceSessionToDaCaseDataTask formatDivorceSessionToDaCaseDataTaskTest;
