...
public class CourtOrderDocumentsUpdateServiceImplTest {
    ...
    @Before
    public void setUp() {
        classUnderTest = new CourtOrderDocumentsUpdateServiceImpl(getObjectMapperInstance(), documentGenerationWorkflow, featureToggleService);
    ...
    @Test
    public void shouldUpdateExistingCourtOrderDocuments_costsOrderJudge() throws WorkflowException, CaseOrchestrationServiceException {
        when(featureToggleService.isFeatureEnabled(Features.OBJECT_TO_COSTS)).thenReturn(true);

        mockWorkflowToAddOrReplaceDocument(DOCUMENT_TYPE_COE, COE, CERTIFICATE_OF_ENTITLEMENT_FILENAME_PREFIX);
        mockWorkflowToAddOrReplaceDocument(COSTS_ORDER_DOCUMENT_TYPE, COSTS_ORDER_JUDGE, COSTS_ORDER_DOCUMENT_TYPE);
        mockWorkflowToAddOrReplaceDocument(DECREE_NISI_DOCUMENT_TYPE, DECREE_NISI, DECREE_NISI_FILENAME);
        mockWorkflowToAddOrReplaceDocument(DECREE_ABSOLUTE_DOCUMENT_TYPE, DECREE_ABSOLUTE, DECREE_ABSOLUTE_FILENAME);

        Map<String, Object> caseData = new HashMap<>();
        caseData.put(D8DOCUMENTS_GENERATED, List.of(
            createCollectionMemberDocument("oldUrl", DOCUMENT_TYPE_COE, CERTIFICATE_OF_ENTITLEMENT_FILENAME_PREFIX),
            createCollectionMemberDocument("oldUrl", COSTS_ORDER_DOCUMENT_TYPE, COSTS_ORDER_DOCUMENT_TYPE),
            createCollectionMemberDocument("oldUrl", DECREE_NISI_DOCUMENT_TYPE, DECREE_NISI_FILENAME),
            createCollectionMemberDocument("oldUrl", DECREE_ABSOLUTE_DOCUMENT_TYPE, DECREE_ABSOLUTE_FILENAME)
        ...
        Map<String, Object> returnedPayload = classUnderTest.updateExistingCourtOrderDocuments(AUTH_TOKEN, caseDetails);
        ...
        verify(documentGenerationWorkflow)
            .run(caseDetails, AUTH_TOKEN, DOCUMENT_TYPE_COE, COE, CERTIFICATE_OF_ENTITLEMENT_FILENAME_PREFIX);
        verify(documentGenerationWorkflow)
            .run(caseDetails, AUTH_TOKEN, COSTS_ORDER_DOCUMENT_TYPE, COSTS_ORDER_JUDGE, COSTS_ORDER_DOCUMENT_TYPE);
        verify(documentGenerationWorkflow)
            .run(caseDetails, AUTH_TOKEN, DECREE_NISI_DOCUMENT_TYPE, DECREE_NISI, DECREE_NISI_FILENAME);
        verify(documentGenerationWorkflow)
            .run(caseDetails, AUTH_TOKEN, DECREE_ABSOLUTE_DOCUMENT_TYPE, DECREE_ABSOLUTE, DECREE_ABSOLUTE_FILENAME);
    }

    @Test
    public void shouldUpdateExistingCourtOrderDocuments_costsOrderJudge_toggledff() throws WorkflowException, CaseOrchestrationServiceException {
        ...
        verify(documentGenerationWorkflow)
            .run(caseDetails, AUTH_TOKEN, DOCUMENT_TYPE_COE, COE, CERTIFICATE_OF_ENTITLEMENT_FILENAME_PREFIX);
        verify(documentGenerationWorkflow)
            .run(caseDetails, AUTH_TOKEN, COSTS_ORDER_DOCUMENT_TYPE, COSTS_ORDER, COSTS_ORDER_DOCUMENT_TYPE);
        verify(documentGenerationWorkflow)
            .run(caseDetails, AUTH_TOKEN, DECREE_NISI_DOCUMENT_TYPE, DECREE_NISI, DECREE_NISI_FILENAME);
        verify(documentGenerationWorkflow)
            .run(caseDetails, AUTH_TOKEN, DECREE_ABSOLUTE_DOCUMENT_TYPE, DECREE_ABSOLUTE, DECREE_ABSOLUTE_FILENAME);
    ...
    @Test
    public void shouldUpdateExistingCourtOrderDocuments_costsOrderJudge_noJudgeCostDecision()
