...
public class DeemedNotApprovedPetitionerEmailTaskTest {

    @Mock
    private EmailService emailService;

    @InjectMocks
    private DeemedNotApprovedPetitionerEmailTask task;

    private Map<String, Object> caseData;
    private DefaultTaskContext testContext;
    private static EmailTemplateNames TEST_TEMPLATE = CITIZEN_DEEMED_NOT_APPROVED;
