...
public class RemoveDnOutcomeFlagWorkflowTest {
    ...
    @Mock
    private RemoveDnOutcomeCaseFlagTask removeDnOutcomeCaseFlagTask;

    @InjectMocks
    private RemoveDnOutcomeCaseFlagWorkflow classToTest;
    ...
    public void givenWorkflow_thenExecuteTask() throws WorkflowException, TaskException {
        ...
        verify(removeDnOutcomeCaseFlagTask).execute(any(TaskContext.class), eq(DUMMY_CASE_DATA));
    }
