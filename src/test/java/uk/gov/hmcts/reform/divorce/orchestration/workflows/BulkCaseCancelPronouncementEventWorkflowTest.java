...
public class BulkCaseCancelPronouncementEventWorkflowTest {
    ...
    @Mock
    private CancelPronouncementDetailsWithinBulkTest cancelPronouncementDetailsWithinBulkTest;
    ...
    public void whenProcessAwaitingPronouncement_thenProcessAsExpected() throws Exception {
        ...
        when(cancelPronouncementDetailsWithinBulkTest.execute(any(TaskContext.class), eq(DUMMY_CASE_DATA))).thenReturn(expected);
