...
public class ProcessPbaPaymentFeatureSwitchedOnTest extends IntegrationTest {
    ...
    private static void assertNoPetitionOnDocumentGeneratedList(List<CollectionMember<Document>> documents) {
        assertEquals(0, documents.stream().filter(ProcessPbaPaymentFeatureSwitchedOnTest::isPetition).count());
    }
