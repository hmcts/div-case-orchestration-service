...
public class SubmitCoRespondentAosCaseTest extends RetrieveAosCaseSupport {
    ...
    private static final String TEST_TRANSFER_CASE_FROM_CTSC_HWF = "transferCaseFromCTSChwf";
    ...
    public void givenCaseIsDisallowedState_whenSubmittingCoRespondentAnswers_thenReturnBadRequest() throws Exception {
        ...
        updateCaseForCitizen(String.valueOf(caseDetails.getId()), null, TEST_TRANSFER_CASE_FROM_CTSC_HWF, userDetails);
