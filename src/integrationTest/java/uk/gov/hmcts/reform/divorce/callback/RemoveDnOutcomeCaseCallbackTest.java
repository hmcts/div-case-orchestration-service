...
public class RemoveDnOutcomeCaseCallbackTest extends IntegrationTest {
    ...
    public void givenCase_whenRemoveDnOutcomeCaseFlag_thenReturnCaseDataWithNoDnOutcomeCaseFlag() {
        ...
        Map<String, Object> response = cosApiClient.removeDnOutcomeCaseFlag(dnOutcomeCase);
        ...
        assertThat(jsonResponse, hasNoJsonPath("$.data.DnOutcomeCase"));
