...
//    private static final String PAYLOAD_CONTEXT_PATH = "fixtures/maintenance/updateCase/";
//
//    @Value("${case.orchestration.maintenance.update.context-path}")
//    private String contextPath;
//
//    @Test
//    public void givenDivorceSession_whenSubmitIsCalled_caseIdIsReturned() {
//        Response submissionResponse = submitCase(getUserDetails().getAuthToken(), "basic-divorce-session.json");
//
//        assertEquals(HttpStatus.OK.value(), submissionResponse.getStatusCode());
//        assertNotEquals(0, submissionResponse.path(CASE_ID_KEY));
//    }
//
//    private Response updateCase(String userToken, String fileName) throws Exception {
