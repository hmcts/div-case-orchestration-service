...
public class GetPetitionIssueFeesTest extends IntegrationTest {
    ...
    private static final String PAYLOAD_CONTEXT_PATH = "fixtures/solicitor/submit/";
    ...
    public void givenCreateEvent_whenGetPetitionIssueFees_thenReturnUpdatedData() throws Exception {
        ...
        Response response = RestUtil.postToRestService(
                ...
                headers,
                ResourceLoader.loadJson(PAYLOAD_CONTEXT_PATH + "ccd-request-data")
        );

        assertEquals(HttpStatus.OK.value(), response.getStatusCode());

        Map<String, Object> responseData = response.getBody().path(CASE_DATA_JSON_KEY);
