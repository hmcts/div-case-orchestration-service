...
public class GeneralReferralPaymentWorkflow extends DefaultWorkflow<Map<String, Object>> {
    ...
    public Map<String, Object> run(CaseDetails caseDetails) throws WorkflowException {
        ...
        log.info("CaseID: {}. General referral payment workflow is going to be executed.", caseId);
    ...
    private Task<Map<String, Object>>[] getTasks(CaseDetails caseDetails) {
        ...
        if (FEE_ACCOUNT_TYPE.equals(paymentType)) {
            log.info("CaseID: {}. General referral payment type of '{}' received", caseId, paymentType);
            tasks.add(furtherPBAPaymentTask);
        } else if (HELP_WITH_FEE_TYPE.equals(paymentType)) {
            log.info("CaseID: {}. General referral payment type of '{}' received", caseId, paymentType);
            tasks.add(furtherHWFPaymentTask);
        } else {
            log.info("CaseID: {}. General referral payment type of '{}' received. No further steps taken", caseId, paymentType);
        }
    ...
    private String getPaymentType(Map<String, Object> caseData) {
        return Optional.ofNullable((String) caseData.get(GENERAL_REFERRAL_PAYMENT_TYPE))
