...
public class FullNamesDataExtractor {
    ...
    public static class CaseDataKeys {
        ...
        public static final String OTHER_PARTY_NAME = OrchestrationConstants.OTHER_PARTY_NAME;
    }
    ...
    public static String getOtherPartyFullName(Map<String, Object> caseData) {
        return nullToEmpty((String) (caseData.get(CaseDataKeys.OTHER_PARTY_NAME))).trim();
    }
}
