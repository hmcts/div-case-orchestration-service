...
@Component
@Slf4j
public class GenericUpdateEmailNotification implements Task<Map<String, Object>> {

    private final EmailService emailService;

    @Autowired
    public GenericUpdateEmailNotification(EmailService emailService) {
    ...
    public Map<String, Object> execute(TaskContext context, Map<String, Object> data) {
        ...
        try {
            emailService.sendEmail(EmailTemplateNames.GENERIC_UPDATE, emailAddress, notificationTemplateVars);
