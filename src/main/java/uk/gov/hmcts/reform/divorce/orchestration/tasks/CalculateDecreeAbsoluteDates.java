...
public class CalculateDecreeAbsoluteDates implements Task<Map<String, Object>> {
    ...
    private static final TemporalAmount ADDED_TIME_UNTIL_RESPONDENT_CAN_APPLY_FOR_DA = Period.ofMonths(3);
    ...
    public Map<String, Object> execute(TaskContext context, Map<String, Object> payload) throws TaskException {
        ...
        LocalDate dateRespondentEligibleForDecreeAbsolute = decreeNisiGrantedDate
            .plus(TIME_UNTIL_APPLICANT_CAN_APPLY_FOR_DA)
            .plus(ADDED_TIME_UNTIL_RESPONDENT_CAN_APPLY_FOR_DA);

        Map<String, Object> payloadToModify = new HashMap<>(payload);
        payloadToModify.put(DATE_RESPONDENT_ELIGIBLE_FOR_DA_CCD_FIELD,
            formatDateForCCD(dateRespondentEligibleForDecreeAbsolute));
