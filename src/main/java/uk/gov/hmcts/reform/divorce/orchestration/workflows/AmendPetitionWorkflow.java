...
import static uk.gov.hmcts.reform.divorce.orchestration.domain.model.CcdEvents.AMEND_PETITION_EVENT_ID;
...
public class AmendPetitionWorkflow extends DefaultWorkflow<Map<String, Object>> {
    ...
    public Map<String, Object> run(String caseId, String authToken) throws WorkflowException {
        execute(
            ...
            ImmutablePair.of(CASE_EVENT_ID_JSON_KEY, AMEND_PETITION_EVENT_ID)
        );
