...
import static uk.gov.hmcts.reform.divorce.orchestration.tasks.dataextractor.AddresseeDataExtractor.getPetitioner;
...
public class AosOverdueCoverLetterGenerationTask extends BasePayloadSpecificDocumentGenerationTask {
    ...
    public String getTemplateId() {
        return AOS_OVERDUE_COVER_LETTER_TEMPLATE_ID.getValue();
    }
