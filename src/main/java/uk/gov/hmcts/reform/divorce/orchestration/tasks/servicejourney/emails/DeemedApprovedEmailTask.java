...
public class DeemedApprovedEmailTask extends SendEmailTask {
    protected static String solicitorSubject = "%s vs %s: Deemed service application has been approved";
    protected static String citizenSubject = "Your ‘deemed service’ application has been approved";
