...
@Component
@Slf4j
public class SolicitorDispensedApprovedEmailTask extends SendEmailTask {

    private static final String SUBJECT = "%s vs %s: Dispense with service application has been approved";

    public SolicitorDispensedApprovedEmailTask(EmailService emailService) {
        super(emailService);
    }
