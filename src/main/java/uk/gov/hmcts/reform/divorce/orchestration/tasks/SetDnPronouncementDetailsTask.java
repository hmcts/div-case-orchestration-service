...
public class SetDnPronouncementDetailsTask implements Task<Map<String,Object>> {
    ...
    public Map<String, Object> execute(TaskContext context, Map<String, Object> caseData) throws TaskException {
        ...
        log.info("Executing SetDnPronouncementDetails task for CaseId: {}", caseId);
        ...
        if (hearingDateTime.isAfter(ccdUtil.getCurrentLocalDateTime())) {
            throw new TaskException("You cannot pronounce a case that has a scheduled pronouncement date that is in the future.");
        }
