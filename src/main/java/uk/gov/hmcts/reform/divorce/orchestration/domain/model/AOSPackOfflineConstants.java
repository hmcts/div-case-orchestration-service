...
public enum AOSPackOfflineConstants {
    ...
    CERTIFICATE_OF_ENTITLEMENT_LETTER_CO_RESPONDENT_DOCUMENT_TYPE("coe-cover-letter"),
    CERTIFICATE_OF_ENTITLEMENT_LETTER_CO_RESPONDENT_FILENAME("FL-DIV-GNO-ENG-00449.docx");
