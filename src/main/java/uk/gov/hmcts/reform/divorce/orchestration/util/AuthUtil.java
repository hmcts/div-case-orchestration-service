...
public class AuthUtil {
    ...
    @Value("${idam.caseworker.superuser.username}")
    private String caseworkerSuperUserName;

    @Value("${idam.caseworker.superuser.password}")
    private String caseworkerSuperUserPassword;
