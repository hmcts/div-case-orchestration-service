...
public class PartyRepresentationChecker {
    ...
    public static boolean isCoRespContactMethodNotDigital(Map<String, Object> caseData) {
        return NO_VALUE.equalsIgnoreCase(String.valueOf(caseData.get(CO_RESPONDENT_IS_USING_DIGITAL_CHANNEL)));
    }
