...
import static uk.gov.hmcts.reform.divorce.orchestration.tasks.dataextractor.CaseDataExtractor.getCaseReference;
import static uk.gov.hmcts.reform.divorce.orchestration.tasks.dataextractor.CoECoverLetterDataExtractor.getHusbandOrWife;
import static uk.gov.hmcts.reform.divorce.orchestration.tasks.dataextractor.FullNamesDataExtractor.getPetitionerFullName;

@Component
public class AwaitingDnPetitionerEmailTask extends PetitionerSendEmailTask {

    public AwaitingDnPetitionerEmailTask(EmailService emailService) {
        super(emailService);
    }

    @Override
    protected EmailTemplateNames getTemplate() {
        return EmailTemplateNames.CITIZEN_AWAITING_DN_SERVED_BY_PROCESS;
    }
    ...
    protected String getSubject(TaskContext context, Map<String, Object> caseData) {
        return "Your wife/husband has not responded to your divorce application";
    }
}
