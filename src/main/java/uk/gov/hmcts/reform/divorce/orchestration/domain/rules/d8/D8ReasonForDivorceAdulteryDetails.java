...
public class D8ReasonForDivorceAdulteryDetails {
    ...
    @When
    public boolean when() {
        return Optional.ofNullable(coreCaseData.getD8ReasonForDivorce()).orElse("").equalsIgnoreCase(REASON_ADULTERY)
            && !Optional.ofNullable(coreCaseData.getD8ReasonForDivorceAdulteryDetails()).isPresent();
    }
