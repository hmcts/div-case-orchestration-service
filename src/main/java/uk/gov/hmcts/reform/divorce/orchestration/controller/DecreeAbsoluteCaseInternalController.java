...
public class DecreeAbsoluteCaseInternalController {
    ...
    public ResponseEntity<String> makeCasesEligibleForDA() throws WorkflowException {
        int casesProcessed = decreeAbsoluteService.enableCaseEligibleForDecreeAbsolute();
