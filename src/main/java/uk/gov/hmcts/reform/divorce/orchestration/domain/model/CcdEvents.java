...
public class CcdEvents {
    ...
    public static final String AOS_NOMINATE_SOLICITOR_EVENT_ID = "aosNominateSol";
    ...
    public static final String AOS_START_FROM_OVERDUE_EVENT_ID = "startAosFromOverdue";
    public static final String AOS_START_FROM_REISSUE_EVENT_ID = "startAosFromReissue";
    ...
    public static final String BO_WELSH_DN_RECEIVED_REVIEW_EVENT_ID = "boWelshDnReceivedReview";
    public static final String BO_WELSH_GRANT_DN_MAKE_DECISION_EVENT_ID = "boWelshGrantDnMakeDecision";
    public static final String BO_WELSH_SUBMIT_DN_CLARIFICATION_EVENT_ID = "boSubmitDnClarification";
    public static final String BO_WELSH_REVIEW_EVENT_ID = "boWelshReview";
    public static final String DECREE_ABSOLUTE_REQUESTED_EVENT_ID = "RequestDA";
    public static final String DN_RECEIVED_EVENT_ID = "dnReceived";
    public static final String DN_RECEIVED_AOS_COMPLETE_EVENT_ID = "dnReceivedAosCompleted";
    public static final String DN_RECEIVED_CLARIFICATION_EVENT_ID = "submitDnClarification";
