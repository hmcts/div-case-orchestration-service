...
public class QuartzConfiguration {
    ...
    public SchedulerFactoryBean schedulerFactoryBean(
        ...
        schedulerFactory.setSchedulerName("Divorce Job Schedule");

        return schedulerFactory;
    }

    @Bean
    public Schedule scheduler(SchedulerFactoryBean schedulerFactoryBean) throws SchedulerException {

        Schedule scheduler = schedulerFactoryBean.getScheduler();
