...
public class SubmitCoRespondentAosCase implements Task<Map<String, Object>> {
    ...
    static {
        ...
        STATE_TO_SUBMISSION_EVENT_MAP.put(AWAITING_ALTERNATIVE_SERVICE, CcdEvents.CO_RESP_SUBMISSION_AWAITING_ALTERNATIVE_SERVICE_EVENT_ID);
        STATE_TO_SUBMISSION_EVENT_MAP.put(AWAITING_PROCESS_SERVER_SERVICE, CcdEvents.CO_RESP_SUBMISSION_AWAITING_PROCESS_SERVER_SERVICE_EVENT_ID);
        STATE_TO_SUBMISSION_EVENT_MAP.put(AWAITING_DWP_RESPONSE, CcdEvents.CO_RESP_SUBMISSION_AWAITING_DWP_RESPONSE_EVENT_ID);
    }
