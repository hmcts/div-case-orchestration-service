...
public class SubmitCoRespondentAosCase implements Task<Map<String, Object>> {
    ...
    static {
        ...
        STATE_TO_SUBMISSION_EVENT_MAP.put(AOS_AWAITING, CO_RESPONDENT_SUBMISSION_AOS_AWAITING);
        STATE_TO_SUBMISSION_EVENT_MAP.put(AOS_AWAITING_SOLICITOR, CO_RESPONDENT_SUBMISSION_AOS_AWAITING);
        STATE_TO_SUBMISSION_EVENT_MAP.put(AOS_STARTED, CO_RESPONDENT_SUBMISSION_AOS_STARTED);
        STATE_TO_SUBMISSION_EVENT_MAP.put(AOS_SUBMITTED_AWAITING_ANSWER, CO_RESPONDENT_SUBMISSION_AOS_SUBMIT_AWAIT);
        STATE_TO_SUBMISSION_EVENT_MAP.put(AOS_OVERDUE, CO_RESPONDENT_SUBMISSION_AOS_OVERDUE);
        STATE_TO_SUBMISSION_EVENT_MAP.put(DEFENDED, CO_RESPONDENT_SUBMISSION_AOS_DEFENDED);
