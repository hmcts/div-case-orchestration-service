...
@Component
public class AosOfflineAdulteryCoRespCaseValidator extends BulkScanFormValidator {
    ...
    static {
        ALLOWED_VALUES_PER_FIELD.put("AOSReasonForDivorce", asList("Adultery"));
        ALLOWED_VALUES_PER_FIELD.put("RespConfirmReadPetition", asList(YES_VALUE, NO_VALUE));
        ALLOWED_VALUES_PER_FIELD.put("CoRespAdmitAdultery", asList(YES_VALUE, NO_VALUE));
