...
@Rule(order = 17)
@Data
public class D8ReasonForDivorceBehaviourDetails {
    ...
    @When
    public boolean when() {
        return Optional.ofNullable(coreCaseData.getD8ReasonForDivorce()).orElse("").equalsIgnoreCase(REASON_BEHAVIOUR)
            && !Optional.ofNullable(coreCaseData.getD8ReasonForDivorceBehaviourDetails()).isPresent();
    }
