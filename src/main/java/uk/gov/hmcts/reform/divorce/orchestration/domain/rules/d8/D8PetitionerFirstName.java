...
@Rule(order = 8)
@Data
public class D8PetitionerFirstName {

    private static final String BLANK_SPACE = " ";
    private static final String ACTUAL_DATA = "Actual data is: %s";
    private static final String ERROR_MESSAGE = "D8PetitionerFirstName can not be null or empty.";
    ...
    @When
    public boolean when() {
        return !Optional.ofNullable(coreCaseData.getD8PetitionerFirstName()).isPresent();
    }
    ...
    public void then() {
        result.add(String.join(
            ...
            ERROR_MESSAGE,
            String.format(ACTUAL_DATA, coreCaseData.getD8PetitionerFirstName())
        ));
    }
}