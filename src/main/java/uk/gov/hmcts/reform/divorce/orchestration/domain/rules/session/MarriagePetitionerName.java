...
public class MarriagePetitionerName {
    ...
    private static final String ERROR_MESSAGE = "marriagePetitionerName can not be null or empty.";
    ...
    @When
    public boolean when() {
        return !Optional.ofNullable(divorceSession.getMarriagePetitionerName()).isPresent();
    }
    ...
    public void then() {
        result.add(String.join(
            ...
            ERROR_MESSAGE,
            String.format(ACTUAL_DATA, divorceSession.getMarriagePetitionerName())
        ));
    }
}