...
public class DecreeAbsoluteGrantedWorkflow extends DefaultWorkflow<Map<String, Object>> {

    private final SetDaGrantedDetailsTask setDaGrantedDetailsTask;
    ...
    public Map<String, Object> run(final CcdCallbackRequest ccdCallbackRequest, final String authToken) throws WorkflowException {
        ...
        String respContactMethodIsDigital = (String) caseDetails.getCaseData().get(RESP_IS_USING_DIGITAL_CHANNEL);

        if (YES_VALUE.equalsIgnoreCase(respContactMethodIsDigital)) {
            return caseDetails.getCaseData();
        }

        // TODO: bulkPrintDaGrantedTask
        return this.execute(
            new Task[] {
